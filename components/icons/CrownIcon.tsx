export const CrownIcon = ({ className }: { className: string }) => (
  ...
  >
    ...
    />
    <path d="M4.875 16.5H13.125" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M7.125 10.5H10.875" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
